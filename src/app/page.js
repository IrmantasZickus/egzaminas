...
export default function Home() {
  ...
  const [sortOrder, setSortOrder] = useState(null); // rusiavimo order
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        console.error('Nepavyko įkelti renginių:', error);
      }
    };
      ...
      <div className={styles.container}>
        <div className={styles.filterCard}>
          <div className={styles.filterItem}>
            <label>Filtruoti pagal kategoriją</label>
            <Select
